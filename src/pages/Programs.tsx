      ...
      <section className="container mx-auto px-4 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {programs.map((program, index) => (
            <Card 
              key={index} 
              className="gradient-card border-0 shadow-soft hover:shadow-float transition-all duration-300 group"
            >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              <Card key={index} className="border-l-4 border-l-primary shadow-soft hover:shadow-float transition-all duration-300">
